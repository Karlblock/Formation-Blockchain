...
[x cases qui représentent diverses tables sql des flèches sont dessinées vers chacune montrant leurs nombreuses relations les unes avec les autres](https://cs50.harvard.edu/extension/2022/fall/notes/7/cs50Week7Slide025.png)
...
deux cases représentant le tableau des émissions et des genres avec une flèche reliant l'identifiant et l'identifiant de l'émission
...
L'opérateur générique %peut être utilisé pour trouver toutes les personnes dont le nom commence par Steve Cun pourrait utiliser la syntaxe SELECT * FROM people WHERE name = LIKE 'Steve C%';.
Index
...
un noeud en haut d'où viennent quatre enfants et en dessous il y a trois enfants provenant d'un des noeuds et deux d'un autre deux d'un autre et trois d'un autre
...
écran de connexion à la clé harvard avec champs nom d'utilisateur et mot de passe
